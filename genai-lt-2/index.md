...
すでに活用されている分野ですが、考えだすといくらでも思いつくと思います。

### これをやりたい、あれをやりたい。デバイス1台でできます
...
ようはLinuxのKVMと同じもの(=Androidで仮想マシンが動かせる)
詳しいアーキテクチャは[この辺](https://source.android.com/docs/core/virtualization/architecture?hl=ja)

カスタムROM界隈では有名な[kdrag0n](https://kdrag0n.dev)が**NestBox**を作った

---

### それで?

OSの仮想化が可能になった(Windows11 Armの動作確認済)
つまり、そのKVM上であれば自由にいろいろと動かせる
たとえば[llama.cpp](https://github.com/ggerganov/llama.cpp)

これはあくまでKVMなので完全に性能を引き出せるわけではないが、夢は膨らむ
